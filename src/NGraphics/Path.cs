...
namespace NGraphics
{
    ...
    public class ArcTo : PathOp
    {
        ...
        public ArcTo(Size radius, bool largeArc, bool sweepClockwise, Point point, double xrot)
        {
            Radius = radius;
            LargeArc = largeArc;
    ...
    public class Path : Element
    {
        ...
        public void ArcTo(Size radius, bool largeArc, bool sweepClockwise, Point point, double xrot)
        {
            Add(new ArcTo(radius, largeArc, sweepClockwise, point, xrot));
        }
